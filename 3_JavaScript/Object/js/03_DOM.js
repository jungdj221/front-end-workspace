//    load :  모든 로드가 다 끝나고
// DOMContentLoaded : DOM 구조가 로드되어도. 실행시점이 더 빠름
...
function btn1() {
  ...
  console.log(div);
  console.log(div[0]); //     <div>Helloo, world!</div>
  console.log(div[1]); //    <div>Helloo, Javascript!</div>
}
function btn2() {
...
function btn3() {
  //동일한  class 속성 값을 갖는태그가 여러개 존재할 수 있기 때문에 배열로 리턴
